...
<iframe height="1500" width="100%" frameborder="no" data-external="1" src="https://th23.shinyapps.io/state_restrictions_network_shiny/"> </iframe>
...
We also used a CDC dataset with COVID case numbers per state, as well as a Census Bureau dataset for state populations, in order to calculate the annual COVID cases per state population (which was then used to color the nodes).

Visit [the CDC website](https://data.cdc.gov/Case-Surveillance/United-States-COVID-19-Cases-and-Deaths-by-State-o/9mfq-cb36) and [the Census Bureau website](https://www2.census.gov/programs-surveys/popest/datasets/2010-2020/national/totals/) to download the datasets.
...
<iframe height="800" width="100%" frameborder="no" data-external="1" src="https://hbassett23.shinyapps.io/blog_text-analysis/"> </iframe>
...
![Word Frequency Map for Week 22](images_and_plots/week_22_map_ss.png)
...
![Word Frequency Map for Week 23](images_and_plots/week_23_map_ss.png)
...
![Word Frequency Map for Week 24](images_and_plots/week_24_map_ss.png)
...
![Sentiment Analysis Map for Week 30](images_and_plots/week_30_sent_ss.png)
...
## Creating an Interactive Clustering Plot in Shiny 
...
<iframe height="800" width="100%" frameborder="no" data-external="1" src="https://hfeibes.shinyapps.io/blog_clusters_3D_shiny/"> </iframe>
...
```{r clusters_breakdown_r_e-png, fig.show='hold', out.width="100%"}
knitr::include_graphics("images_and_plots/clusters_breakdown_r_e.png")
```

```{r clusters_breakdown-gif, fig.show='hold', out.width="80%"}
...
<iframe height="1400" width="100%" frameborder="no" data-external="1" src="https://hfeibes.shinyapps.io/blog_r-e-network_shiny/"> </iframe>
...
Overall, we aimed to take a closer look at COVID-related relationships using networks, unsupervised clustering, and geo-spatial analysis. We each came to separate conclusions, since our elements of the projects were using very different techniques and therefore brought us to different analyses, but we all realized the value of using these more advanced techniques in enriching our understanding of how the COVID-19 pandemic affected Americans. There is so much more nuance in these discoveries---as opposed to the much more limited conclusions that we were able to draw from the very rigid Household Pulse Survey---that let us challenge our prior assumptions, gave us fresh insights into important elements of the pandemic that we may have overlooked previously, and provided more engaging ways for our audience to interact with our findings. By using these techniques for this "color commentary," so to speak, we were able to feel like we were interacting with Americans and their lives themselves, rather than interfacing with them through the language of data that could not conform fully to the realities of pandemic life. We are grateful that this project allowed us to delve deeper into our exploration of the pandemic and look forward to continuing to widen our understanding of COVID-19's lasting impact.
