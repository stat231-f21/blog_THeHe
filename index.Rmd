...
We also used a dataset for annual COVID cases, as well as a    , to calculate the annual COVID cases per state population (which was then used to color the nodes).
Visit [the website]() and [next website]() to download the datasets.
